    ...
    <>
      <div className="single-project-page-design">
        ...
        <div className="container pt-60 pb-40">
          <div className="row">
            ...
            <div className="col-lg-8">
              <div className="single-project-page-right wow fadeInUp delay-0-4s">
                ...
                <p>Our bespoke suits and shirts are tailored to perfection, offering a flawless fit and refined style. Crafted from premium fabrics, each piece is designed to exude sophistication and comfort.</p>
              </div>
            </div>
          </div>
          ...
          <ContactForm title="Design Your Suits" />
        </div>
      </div>
